...
#     2. Gets the user's conversation history
#     3. Builds the message list for the LLM
...
#         relevant_docs = vector_store.query(request.question)
...
#         # Get user's conversation history and add to messages
#         user_conversation = get_user_conversation_history(request.user_id)
...
#         save_conversation(request.user_id, request.question, response_content)
        
#         return ChatResponse(response=response_content, reasoning="")
